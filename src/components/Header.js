      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <nav className="flex space-x-6">
            ...
            <Link href="/income" className="text-sm font-medium text-gray-700 hover:text-gray-900 transition">
              Client Payments
            </Link>
            <Link href="/accounts" className="text-sm font-medium text-gray-700 hover:text-gray-900 transition">
              Manage Accounts
            </Link>
          </nav>
        </div>
